...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'chunxiaoliao_ContigFilter'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from chunxiaoliao_ContigFilter.chunxiaoliao_ContigFilterImpl import chunxiaoliao_ContigFilter
impl_chunxiaoliao_ContigFilter = chunxiaoliao_ContigFilter(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['chunxiaoliao_ContigFilter.filter_contigs_async'] = ['chunxiaoliao_ContigFilter', 'filter_contigs']
async_check_methods['chunxiaoliao_ContigFilter.filter_contigs_check'] = ['chunxiaoliao_ContigFilter', 'filter_contigs']
sync_methods['chunxiaoliao_ContigFilter.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'chunxiaoliao_ContigFilter'
        ...
        self.rpc_service.add(impl_chunxiaoliao_ContigFilter.filter_contigs,
                             name='chunxiaoliao_ContigFilter.filter_contigs',
                             types=[dict])
        self.method_authentication['chunxiaoliao_ContigFilter.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "chunxiaoliao_ContigFilter but no authentication header was passed"
                            raise err
