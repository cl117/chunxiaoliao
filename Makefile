SERVICE = chunxiaoliao_contigfilter
SERVICE_CAPS = chunxiaoliao_ContigFilter
SPEC_FILE = chunxiaoliao_ContigFilter.spec
URL = https://kbase.us/services/chunxiaoliao_contigfilter
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
